namespace SynchroSetup
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.columnSyncTo = new System.Windows.Forms.ColumnHeader();
			this.columnSyncFrom = new System.Windows.Forms.ColumnHeader();
			this.columnSyncSubs = new System.Windows.Forms.ColumnHeader();
			...
			this.listView1.Size = new System.Drawing.Size(755, 159);
			...
			this.columnSyncTo.Width = 181;
			// 
			// columnSyncFrom
			// 
			this.columnSyncFrom.Text = "Sync From";
			this.columnSyncFrom.Width = 174;
			// 
			// columnSyncSubs
			// 
			this.columnSyncSubs.Text = "+Subs";
			this.columnSyncSubs.Width = 47;
			// 
			// columnStatus
			// 
			...
			this.button1.Click += new System.EventHandler(this.buttonAddSync_Click);
			// 
			// button2
			// 
